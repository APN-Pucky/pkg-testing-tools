...
```
install -m 0750 -o portage -g portage -d {EPREFIX}/etc/portage/env {EPREFIX}/etc/portage/package.{accept_keywords,env,unmask,use}
```

Alternatively, it will create those directories on the first run.
